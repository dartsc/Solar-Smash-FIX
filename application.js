  ...
  function createApplication(_ref) {
    ...
    function start(_ref4) {
      ...
      return Promise.resolve().then(function () {
        ...
        cc = engine;
        // Runtime safeguard: some builds omit the MotionStreak module; if missing, stub it to avoid deserialization errors.
        try {
          if (!cc.MotionStreak && cc._decorator && cc.Component) {
            var _cc$_decorator = cc._decorator,
                ccclass = _cc$_decorator.ccclass;
            var MotionStreakStub = /*#__PURE__*/function (_cc$Component) {
              babelHelpers.inherits(MotionStreakStub, _cc$Component);
              var _super = babelHelpers.createSuper(MotionStreakStub);
              function MotionStreakStub() {
                babelHelpers.classCallCheck(this, MotionStreakStub);
                return _super.apply(this, arguments);
              }
              return MotionStreakStub;
            }(cc.Component);
            MotionStreakStub = ccclass('cc.MotionStreak')(MotionStreakStub);
            cc.MotionStreak = MotionStreakStub;
            console.warn('[MotionStreak] Missing module detected. Registered a no-op stub to keep the game running.');
          }
        } catch (e) {
          console.warn('[MotionStreak] Stub registration failed:', e);
        }
